    ...
    return(  
        <>
            ...
            <div className='main_wrapper'>
                ...
                <br></br>
                <Card title={'Work Term Report 3 - Kenna'} desc={`In this work term report, I share my experiences working at Kenna as an application developer for another 4 months which was my second co-op with them, highlighting what I've learned, and how I accomplished my goals.`}/>
            </div>
        </>
    );
};
